...
// LBGIFImage
#define COCOAPODS_POD_AVAILABLE_LBGIFImage
#define COCOAPODS_VERSION_MAJOR_LBGIFImage 0
#define COCOAPODS_VERSION_MINOR_LBGIFImage 0
#define COCOAPODS_VERSION_PATCH_LBGIFImage 1
